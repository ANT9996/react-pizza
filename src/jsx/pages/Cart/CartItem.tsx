...
const CartItem:React.FC<CartItem> = ({ size, id, type , imageUrl, title, count, price}) => {
    const item = {size, id, type , imageUrl, title, count, price}
    ...
    const onClickRemove = () => {
        if (window.confirm('Удалить эту пиццу?')) dispatch(removeItem(item))
    }
    return (
